...
import { fetchCustomerData, addCustomerData, updateCustomerData, deleteCustomerData } from '../../service/getCustomerData';
...
const CustomerListRecord = () => {
  ...
  const handleUpdateCustomer = async (customerId, updatedData) => {
    try {
      await updateCustomerData(customerId, updatedData);
      const updatedCustomers = customers.map((customer) =>
        customer.cid === customerId ? { ...customer, ...updatedData } : customer
      );
        ...
        {loading ? (
          ...
          <div>
            <Table
              data={customers}
              loading={loading}
              onUpdateClick={handleUpdateCustomer} // Pass the update handler to the Table component
